						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									$cats = $conn->query("SELECT pl.*, cl.name as cat_name FROM `product_list` as pl, category_list as cl WHERE pl.category_id = cl.id");
									...
									<tr>
										...
										<td class="">
											...
											<p>Category : <b><?php echo $row['cat_name'] ?></b></p>
...
<script>
	...
	$('#manage-menu').submit(function(e){		
		...
		$.ajax({
			...
			data: new FormData($(this)[0]), //fetching data from form
		    cache: false,
		    contentType: false,
		    processData: false,
		    method: 'POST',
