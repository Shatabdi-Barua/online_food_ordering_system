  ...
  <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
          <div class="col-lg-10 align-self-center mb-4 page-title">
              <h1 class="text-white" id="wlcm"> -->
                <!-- Welcome to <?php echo $_SESSION['setting_name']; ?> -->
                <!-- Welcome!!
              </h1>
              <hr class="divider my-4 bg-dark" />
              <a class="btn btn-dark bg-black btn-xl js-scroll-trigger" id="order_btn" href="#menu">Order Now</a>
    ...
    <div class="row mx-0">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="menu-field" class="card-deck px-2 py-3 justify-content-center">                   
                ...
                if(isset($_GET['_page']) && $_GET['_page'] > 0)
                {
                    $page = $_GET['_page'] - 1;
                }
                else{
                ...
                $all_menu = $conn->query("SELECT id FROM  product_list")->num_rows; //3
                // echo 'num_rows -> '.$all_menu;
                $page_btn_count = ceil($all_menu / $limit); //0.3
                ...
                <div class="col-lg-3 mb-3">
                    ...
                    <div class="card-body rounded-0">
                        ...
                        <div class="card-price">
                            <p class="card-text price">Unit price: <?php echo number_format($row['price'], 2) ?></p>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-2"><label class="control-label">Qty</label></div>
                            <div class="input-group col-md-7 mb-3 qty-design">
                        ...
                        <div class="text-center">
                            <button class="btn btn-sm btn-outline-dark btn-block" data-id=<?php echo $row['id'] ?> onclick="add_to_cart_prod(<?php echo $row['id'] ?>)"><i class="fa fa-eye"></i> Add to cart</button>                
                        </div>
                    </div>
...
<script>  
  $('.view_prod').click(function(){
      ...
      /* * display modal
        * print title "product details" 
        * go to "view_prod.php" page with the id of the product 
        */
  })
</script>
